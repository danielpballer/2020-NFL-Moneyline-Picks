...
```{r saving individual table, eval=FALSE, include=FALSE}
gtsave(indiv_table, glue::glue("../Individual_Tables/Individual_Table_Week_{length(weeks)}.png"))
```
...
```{r saving individual cadet table, include=FALSE}
gtsave(c_indiv_table, glue::glue("../Individual_Tables/Cadet_Individual_Table_Week_{length(weeks)}.png"))
```
