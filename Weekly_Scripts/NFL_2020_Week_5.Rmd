...
weeks = list(1,2,3,4,5) #Setting the weeks #add in additional weeks
inst.picks = list(week_1, week_2, week_3, week_4, week_5) #add in the additional weeks
cdt.picks = list(cadet_wk1, cadet_wk2, cadet_wk3, cadet_wk4, cadet_wk5) #add in the additional weeks
```

```{r read in scores clean data, include=FALSE}
Scores = read_csv("../CSV_Data_Files/NFL_Scores_5.csv") #%>% janitor::clean_names()
