...
weeks = list(1,2,3,4,5,6,7,8) #Setting the weeks #add in additional weeks
...
Scores = read_csv("../CSV_Data_Files/NFL_Scores_7.csv") #%>% janitor::clean_names()
